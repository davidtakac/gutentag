  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(e['name']!, overflow: TextOverflow.ellipsis, maxLines: 1, style: theme.textTheme.bodyLarge,),
                            Text(code, overflow: TextOverflow.ellipsis, maxLines: 1, style: theme.textTheme.bodyMedium?.copyWith(color: theme.hintColor),),
                          ],
                        ),
                      ),
                    )
      ...
      actions: [
        ...
        TextButton(
            onPressed: () => widget.onSubmit(selectedCodes),
...
List<Map<String, String>> _getLanguages() => [
  { "code": "aa", "name": "Afar" },
